...
const { add_Employees, getAll_Employees, getOne_Employee, update_Employee, delete_Employee , uploadExcelEmployees } = require('../controllers/employees');
...
employee_Router.post("/upload-excel", upload.single("file"), uploadExcelEmployees);
